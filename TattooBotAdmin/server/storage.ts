...
function createDefaultMessages(): BotMessage[] {
  return [
    ...
    },
    {
      ...
      value: "👋 Привет! Готовы записаться? Нажмите Старт, чтобы подтвердить условия и продолжить.",
      type: "textarea",
      imageUrl: null,
    },
    {
    ...
    },
    {
      ...
      key: "captcha_prompt",
      label: "Капча",
      value: "Для защиты от спама решите пример: {a} + {b} = ?",
      type: "textarea",
      imageUrl: null,
    },
    {
      ...
      value: "Неа. Пришли число ещё раз.",
      type: "textarea",
      imageUrl: null,
    },
  ];
